<div class="container px-4 mx-auto">
    ...
    <div class="pt-6 mb-20 text-center">
        <div x-data="{
            ...
            title="Copy Link"
            class="px-4 py-1 mx-auto text-lg font-semibold text-pink-400 bg-gray-800 border border-gray-700 cursor-pointer sm:text-xl w-fit">
    ...
    <div class="">
        ...
        <div class="last:border-b last:border-b-gray-700">
            @if (!$filteredKontak)
            <div class="text-xl font-bold text-center text-gray-400 sm:text-3xl">Kontak Tidak Dapat Ditemukan</div>
            @else
